...
import com.cinemille.it.repository.SalaRepository;
...
/**
 * Service Implementation for managing {@link com.cinemille.it.domain.Sala}.
 */
@Service
@Transactional
public class SalaService {
    ...
    public Sala update(Sala sala) {
        log.debug("Request to update Sala : {}", sala);
        return salaRepository.save(sala);
    }
    ...
    public Optional<Sala> partialUpdate(Sala sala) {
        ...
        return salaRepository
            .findById(sala.getId())
            .map(existingSala -> {
                if (sala.getCapienza() != null) {
                    existingSala.setCapienza(sala.getCapienza());
                }
                if (sala.getTipo() != null) {
                    existingSala.setTipo(sala.getTipo());
                }
